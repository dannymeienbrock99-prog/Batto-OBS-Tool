...
const CHANNELS = new Set([
  ...
  "action:execute", "plugins:scan", "plugins:enable", "plugins:settings", "plugins:import", "plugins:import-folder",
  "sotf:refresh", "sotf:open-overlay", "sotf:copy-overlay", "window:toggle-fullscreen",
