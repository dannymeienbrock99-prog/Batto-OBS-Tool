...
contextBridge.exposeInMainWorld("batto", Object.freeze({
  ...
  testV4Module: (id) => ipcRenderer.invoke("v4:module:test", id),
  getV4Media: () => ipcRenderer.invoke("v4:media:list"),
  importV4Media: () => ipcRenderer.invoke("v4:media:import"),
  deleteV4Media: (name) => ipcRenderer.invoke("v4:media:delete", name),
  openV4MediaFolder: () => ipcRenderer.invoke("v4:media:open-folder"),
  getCohostStatus: () => ipcRenderer.invoke("v4:cohost:status"),
  copyCohostUrl: () => ipcRenderer.invoke("v4:cohost:copy-url"),
  openCohostOverlay: () => ipcRenderer.invoke("v4:cohost:open"),
  getLiveToolsStatus: () => ipcRenderer.invoke("v4:live-tools:status"),
  exportV4Backup: () => ipcRenderer.invoke("v4:backup:export"),
  importV4Backup: () => ipcRenderer.invoke("v4:backup:import"),
  ...
  testChatFilter: (input) => ipcRenderer.invoke("chat-filter:test", input),
